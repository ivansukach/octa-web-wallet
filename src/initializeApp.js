...
import { NetworksAll, Validators } from "@/gql"
...
export default async function init(urlParams, env = process.env) {
  ...
  // console.log("NetworksAll: " + NetworksAll)
  // await apolloClient.query({
  //   query: Validators,
  //   fetchPolicy: "network-only",
  // })
  // const restLink = new RestLink({ uri: "http://localhost:4000/graphql" })
  ...
  // await store.dispatch(`preloadValidators`)
